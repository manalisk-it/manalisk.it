...
schema_service_type: Consulenza e sviluppo di soluzioni di intelligenza artificiale e automazione
...
services:
  - kicker: Automazioni
    ...
    examples:
      - "**Calendari e appuntamenti:** creazione automatica di eventi, promemoria e aggiornamenti a partire da form, email o richieste dei clienti."
  ...
  - kicker: Documenti
    ...
    examples:
      - "**Digitalizzazione di archivi storici:** contratti, fatture e lettere vengono convertiti in testo tramite OCR e archiviati con una struttura coerente."
  ...
  - kicker: Ricerca interna
    ...
    examples:
      - "**Per un'azienda:** un motore di ricerca interno permette ai dipendenti di interrogare procedure, regolamenti e contratti con riferimenti alle fonti."
  ...
  - kicker: Estrazione
    ...
    examples:
      - "**Per un'azienda:** lettura di fatture e ordini per estrarre importi, fornitori e codici da inserire nel gestionale."
  ...
  - kicker: Analisi
    ...
    examples:
      - "**Per l'amministrazione:** analisi delle spese per centro di costo e individuazione delle voci ricorrenti o fuori controllo."
  ...
  - kicker: Previsioni
    ...
    examples:
      - "**Per l'ufficio vendite:** previsione della domanda per prodotto e area geografica, a supporto di produzione e approvvigionamento."
  ...
  - kicker: Consulenza
    ...
    examples:
      - "**Per una PMI:** individuazione delle attività ripetitive da automatizzare e definizione di un piano di adozione graduale."
  ...
  - kicker: Formazione
    ...
    examples:
      - "**Per il management:** percorso introduttivo per comprendere opportunità, limiti e implicazioni strategiche dell'AI."
